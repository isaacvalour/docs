...
description: "Learn how to authenticate and secure your API calls with HR API"
---

## Overview

HR API uses JWT (JSON Web Tokens) for authentication. This guide covers all aspects of authentication including login, token management, 2FA, and security best practices.
...
Access tokens expire after **2 hours**. When a token expires, you'll receive a 401 Unauthorized response:
...
const response = await client.makeRequest('/v1/users/me');
